...
echo [1/5] Resolviendo cruces de eliminatoria confirmados...
python actualizar_calendario_knockout.py

echo.
echo [2/5] Leyendo pronosticos del Google Form...
python leer_pronosticos_form.py

echo.
echo [3/5] Descargando resultados reales y generando datos.json...
...
echo.
echo [4/5] Copiando datos.json, index.html y calendario.json al repositorio...
